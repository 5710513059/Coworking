...
<?php
include('connection.php');
$query = "SELECT SUM(Usercount) AS totol, DATE_FORMAT(DateReceip, '%D') AS DateReceip
FROM booksa
GROUP BY DATE_FORMAT(DateReceip, '%D%')
";
...
<table width="200" border="1" cellpadding="0"  cellspacing="0" align="center">
  ...
  <tr>
    <th width="10%" bgcolor ="  #FF6699"><center>วัน</th></center>
    <th width="10%" bgcolor =" #33FF33"><center>จำนวนคนที่มาใช้บริการ</th></center>
  </tr>


  <?php while($row = mysqli_fetch_array($result)) { ?>
    <tr>
      <td align="center" bgcolor ="#FDB4BF"><center><?php echo $row['DateReceip'];?></center></td>
      <td align="center" bgcolor ="#99FF66"><center><?php echo $row['totol'];?></center></td>
    </tr>
    <?php } ?>
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
           label: 'รายงานภาพรวม แยกตามรายวัน (คน)', 
            data: [<?php echo $totol;?>
            ],
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
