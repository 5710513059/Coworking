		...
		<div id="page-wrapper">
				...
				<header id="header" class="alt">
					...
					<nav id="nav">
						<ul>
							...
							<li class="current"><a href="แนะนำผู้ใช้ทั่วไป.php">คำแนะนำ</a></li>
			...
			<!-- Banner -->
				<section id="banner">
					...
					<h1 style="background-color:#FF0066;">เวลาเปิดทำการ 9.00-20.00 น. สามารถทำการจองห้องได้ครั้งละ 1 ชั่วโมง</h1>
